function [Lines,Vertices,Objects]=isocontour_orig(I,isovalue)
...
B=Img>=isovalue;
off_limits = Img == 255;
off0=off_limits(1:end-1,1:end-1); off1=off_limits(1:end-1,2:end);
off2=off_limits(2:end,1:end-1); off3=off_limits(2:end,2:end);
off_all = off0 | off1 | off2 | off3;
